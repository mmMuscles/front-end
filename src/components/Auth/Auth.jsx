      ...
      <div className="footie">
        {user.email ? (
          <main>
            ...
            <button
              className="bg-blue-300 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded w-22 border-4"
            ...
            <Link
              to="/calendar"
              className="bg-slate-500 hover:bg-slate-700 rounded px-5 m-5"
            >
              Calendar
            </Link>
            <Link
